...
class GetCountdownCard extends StatefulWidget {
  final GetEventModel event;

  const GetCountdownCard({super.key, required this.event});

  @override
  State<GetCountdownCard> createState() => _GetCountdownCardState();
}

class _GetCountdownCardState extends State<GetCountdownCard> {
  late Timer _timer;
  ...
  void initState() {
    ...
    _notificationService.initializeNotification().then((_) {
      ...
      _notificationService.scheduleNotificationOnFinishRemote(
        widget.event.title,
