  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.eventToEdit == null ? 'New countdown' : 'Edit Event'),
      ),
      body: Form(
        key: _formKey,
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Event Date & Time', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    ...
                    child: ElevatedButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(_formatDate(_selectedDate), style: const TextStyle(fontSize: 16, color: secondColor)),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: ElevatedButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(_selectedTime.format(context), style: const TextStyle(fontSize: 16, color: secondColor)),
                        ],
                      ),
                    ),
                  ),
